	...
	\begin{figure}[H]
		...
		\end{figure}
			...
			\subsection{Goal-Domain tracing}
				...
				Validation, both as developers and customers, gave us a lot of good feedback and we felt that it improved the qualtiy of our Requirements Specification. During the validation process we got the chance to break down the project and look at specific parts by them self. This made it easier for us in the requirements team to disregard all the domain knowledge that we had gathered after working with the prohject for a long time. The validation report provided by our customer also gave us a lot to work with. It was apparent that some requirements that were obvious to us was not so clear when read by another party. So the most intresting results from the checklist was perhaps not the part where the customer gave feedback on things that they deemed needed clearification but the parts where their comment showed us that the had misunderstood or misinterperted something about the system. The fact that they thought that the system worked in a way (that was not the way we intended it to) exposed the fact that there was a level of ambiguity in the Requirements Specification. This is very dangerous as if we and the customer do not look the same way on the specification the validation might be incomplete and not be correct according to the customer expectations. Missunderstandings are never a good thing. In our case we tried clearify all the sections of the Requirements Specification where we found any indication of ambiguity. Mainly by reqriting the text and give more examples. 
