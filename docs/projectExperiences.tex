...
In this paragraph each group member briefly explains its individual contributions to the project result.
	...
	\subsection{Hannes}
		...
		\subsubsection{R2}
		This release has consised of a lot of reqT-work for me. Adding all features, goals, design-level requirements into scala files. Also eliciting, prioritizing and validating requirements both within the team and with external stakeholders.
		\subsubsection{R3}
