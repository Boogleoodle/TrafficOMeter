...
A data model is an abstract model of what data is needed in a system. It is not necessarily a requirement but in our case we use the model as a requirement.
	...
	\section{Release planning}
		%Skriv lite mer om release planning
		%
		%	varför man inte ska bara göra en release planning/gång utan flera.
		%	blanda inte prioriteringar och 100 pengar. Det fungerar inte, vi valde att anpassa release planen med cust och gov i åtanke för vi inte gjort någon 100 penga metod med potentiella users.
		%
